...
| **IoT Dual Mode Relay Control** | [iot-dual-mode-relay-control]([https://github.com/prathameshsalunkhe/IoT-Relay](https://github.com/prathameshsalunkhe/IoT-Based-Dual-Mode-Relay-Control)) | ESP12F project demonstrating MQTT and HTTP-based relay control for smart home applications. Dual-mode control for flexibility. |
